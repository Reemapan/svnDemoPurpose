...
$customerid=$_SESSION["parent_email"];
...
<input type='hidden' class="name" name='item_name' value='<?php echo "newzworm"; ?>'>
...
<input type='hidden' name='cancel_return' value='https://www.newzworm.com/cancel.php?pageid=cancel'>
<input type='hidden' name='return' value='https://www.newzworm.com/success.php?pageid=success&customerid=<?php echo $customerid; ?>&order_id=<?php echo $orderid; ?>'>
<input type="hidden" name="notify_url" value="https://www.newzworm.com/" />
...
$profile_sql=mysql_query("select name,email,mobile from nluser where email='$customerid'");
$profile_fetch_sql=mysql_fetch_assoc($profile_sql);
...
if($profile_fetch_sql['name']){ $name=$profile_fetch_sql['name'];}else{ $name='guest';}
$posted['amount']=$amount;
$posted['firstname']=$name;
$posted['email']=$profile_fetch_sql['email'];
$posted['username']=$profile_fetch_sql['name'];
$posted['phone']=$profile_fetch_sql['mobile'];
$posted['productinfo']='test';
$posted['surl']='https://newzworm.com/success_payu.php';
$posted['furl']='https://newzworm.com/failure.php';
